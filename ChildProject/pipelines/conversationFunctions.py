...
def cry_voc_speaker(annotations: pd.DataFrame, duration: int, **kwargs):
    ...
    # elif 'cries' in annotations.columns:
        ...
        return annotations[annotations['speaker_type'] == kwargs["speaker"]]["cries"].apply(
            lambda x: len(ast.literal_eval(x))).sum()
...
{"speaker_type", "vcm_type", "duration"}, {"speaker_type", "child_cry_vfx_len"}))(
    peak_hour_metric()(cry_voc_dur_speaker))
cry_voc_dur_speaker_ph = metricFunction({"speaker"}, (
{"speaker_type", "vcm_type", "duration"}, {"speaker_type", "child_cry_vfx_len"}))(
    per_hour_metric()(cry_voc_dur_speaker))
cry_voc_dur_speaker = metricFunction({"speaker"},
                                     ({"speaker_type", "vcm_type", "duration"}, {"speaker_type", "child_cry_vfx_len"}))(
    cry_voc_dur_speaker)


@metricFunction({"speaker"}, ({"speaker_type", "vcm_type", "duration"}, {'speaker_type', "child_cry_vfx_len", "cries"}),
                np.nan)
